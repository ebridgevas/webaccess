...
(function ($, document, window) {
	...
	$.fn[mobileMenu] = function (options) {
		return this.each(function() {
            ...
            /*
             * Original code.
             * Replaced by David Tekeshe - 19 March 2014
             *
			// create menu bar
            ...
            */
            ...
            var menuBar = $('<div class="'+prefix+'_menu" style="right: 0px;z-index: 20;position:fixed"></div>');
            ...
            var menuLogo = $('<div style="display: inline-block;left: 0px;">' +
                             ...
                             '          <span class="standard-font">Telecel Zimbabwe</span>' +
                             '          <span class="small-font">Web Portal</span>' +
                             '      </div>' +
                             '   </div>' +
                             '</div>');

            /* --- Menu button. */
            var btn = $('<' + settings.parentTag+' aria-haspopup="true" tabindex="0" class="' + prefix + '_btn" style="display: inline-block;right: 0px;width: 32px;">' +
            ...
            $(menuHeader).append( menuLogo );
            $(menuHeader).append( btn );
            $(menuBar).append(menuHeader);

            /* Prepend menubar to 'body' */
            $(settings.prependTo).prepend(menuBar);

            /* Menu "Content" - just to facilitate white space placeholder.*/
            var menuContentPane = $('<div></div>');

            var menuWhiteSpacePane = $('<div style="display: none"><span style="display: none">White space Placeholder</span></div>');
            ...
            /* Append this '#menu' to menu bar. */
//            menuBar.append(mobileNav);
            menuBar.append( menuContentPane );
